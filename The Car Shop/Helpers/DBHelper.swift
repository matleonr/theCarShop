...
class DBHelper {
    ...
    func fillCarsTable() {
        if getCars().count == 0 {
            for carToFill in generateCarsToFill() {
                let carToInsert = carsTable.insert(model <- carToFill.model!, seats <- carToFill.seats!, status <- carToFill.status!, price <- carToFill.price!, datereleased <- carToFill.dateReleased!, category <- carToFill.category!)
                do {
    ...
    func generateCarsToFill() -> [Car] {
        ...
        let car1 = Car(id: 1, model: "Chevrolet Camaro", seats: 4, status: "used", price: 36500, dateReleased: 1969, category: "commercial")
        let car2 = Car(id: 2, model: "Dogde Challenger", seats: 4, status: "used", price: 15000, dateReleased: 1970, category: "commercial")
        let car3 = Car(id: 3, model: "Ford Mustang", seats: 4, status: "used", price: 34900, dateReleased: 1964, category: "commercial")
        let car4 = Car(id: 4, model: "Renault Twizy", seats: 2, status: "new", price: 8886, dateReleased: 2011, category: "electric")
        let car5 = Car(id: 5, model: "Tesla Model 3", seats: 5, status: "new", price: 59088, dateReleased: 2016, category: "electric")
        let car6 = Car(id: 5, model: "Ssangyong Tivoli", seats: 5, status: "new", price: 7510, dateReleased: 2014, category: "truck")
        let car7 = Car(id: 4, model: "Renault Twingo", seats: 4, status: "used", price: 5739, dateReleased: 1993, category: "commercial")
